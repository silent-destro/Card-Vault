...
import { UserPlus, BookOpen, Calendar, Phone, Clock, MapPin, QrCode, Download } from "lucide-react";
import {
  GoogleReviewLogo,
  GPayLogo,
  InstagramLogo,
...
END:VCARD`;
  ...
  const downloadQRCode = async () => {
    try {
      const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=${encodeURIComponent(cardUrl)}&bgcolor=ffffff&color=000000&margin=0`;
      ...
      link.href = blobUrl;
      link.download = `${card.businessName} CardVault-Online Business Card.png`;
      ...
      alert("Failed to download QR code. Opening in a new tab instead.");
      const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=${encodeURIComponent(cardUrl)}&bgcolor=ffffff&color=000000&margin=0`;
